...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Events with video recordings for the Events Library';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    ...
    performers: Schema.Attribute.Relation<'manyToMany', 'api::person.person'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'People who perform or are guests in events';
    displayName: 'Person';
    pluralName: 'people';
    singularName: 'person';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    events_as_guest: Schema.Attribute.Relation<
      'manyToMany',
      'api::event.event'
    >;
    events_as_performer: Schema.Attribute.Relation<
      'manyToMany',
      'api::event.event'
    >;
...
export interface ApiRecordingRecording extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Video recordings for events';
